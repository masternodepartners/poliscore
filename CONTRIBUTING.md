...
- https://labs.bitpay.com/c/poliscore (Support Forum)
- https://gitter.im/bitpay/poliscore (Development Chat)
...
These are some global design goals in poliscore that any change must adhere.
...
When possible, poliscore objects should have standard methods on an instance prototype:
...
#### T3 - Require 'poliscore' and Look up Classes from There

This helps to make tests more useful as examples, and more independent of where they are placed. This also helps prevent forgetting to include all submodules in the poliscore object.
...
```sh
git remote add bitpay git@github.com:bitpay/poliscore.git
...
```
Finally go to [github.com/bitpay/poliscore](https://github.com/bitpay/poliscore) in your web browser and issue a new pull request.

Main contributors will review your code and possibly ask for changes before your code is pulled in to the main repository.  We'll check that all tests pass, review the coding style, and check for general code correctness. If everything is OK, we'll merge your pull request and your code will be part of poliscore.

If you have any questions feel free to post them to
[github.com/bitpay/poliscore/issues](https://github.com/bitpay/poliscore/issues).
